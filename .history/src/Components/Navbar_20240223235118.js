    ...
    <nav>
      <div className="flex fixed items-center justify-between border border-gray-400 py-4 px-8 w-full z-10 bg-white">
        ...
        <ul className="flex gap-10 text-xl">
          <li className='hover'><a href="#gauntlet">इतिहास</a></li>
          <li className='hover'><a href="#sword">'स्व'-रूपवर्धिनी</a></li>
          <li className='hover'><a href="#archery">सादरीकरणे </a></li>
          <li className='hover'><a href="#about">अभिप्राय</a></li>
          <li className='hover'><a href="#contact">संपर्क</a></li>
        </ul>
      </div>
    </nav>
  );
