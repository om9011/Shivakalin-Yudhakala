        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div className="bg-white rounded-lg ">
            <img
              ...
              className="w-full mb-5"
            ></img>
            <h3 className="text-2xl font-semibold mb-2 text-tertiary">
              दानपट्टा
            </h3>
            <p className="text-gray-700 text-justify p-6">
              Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus
              ...
              Fusce tempor lorem ac lacinia porttitor. Sed ut massa dolor.
              Nullam tempor, sapien suscipit aliquam efficitur, nibh turpis
              lacinia ante, eu vehicula lacus turpis eu arcu. Cras sed porttitor
              nisl. Phasellus placerat, ipsum molestie placerat varius, ipsum
              ligula porta neque, at imperdiet odio neque eu orci. Praesent
              pretium sodales congue. Aliquam erat volutpat.
            </p>
          </div>
        </div>
      </div>
