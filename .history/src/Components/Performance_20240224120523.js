    ...
    <div className="flex flex-col items-center justify-center">
      <div className="max-w-md rounded overflow-hidden shadow-lg">
        ...
        <div className="px-6 py-4">
          <div className="font-bold text-xl mb-2" style={{ color: theme.primary }}>Performance {performances[currentPerformance].id}</div>
          <p className="text-gray-700 text-base">
            <span style={{ color: theme.secondary }}>Date:</span> {performances[currentPerformance].date}<br />
            <span style={{ color: theme.secondary }}>Location:</span> {performances[currentPerformance].location}
          </p>
        </div>
      </div>
