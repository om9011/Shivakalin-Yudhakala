...
const PerformanceSection = () => {
    ...
    return (
        <div className="performance-slider-container bg-background flex flex-col items-center justify-start py-14 px-4">
            <h2 className='text-5xl text-primary font-semibold'>सादरीकरणे</h2>
            <div className="performance-slider my-10" style={{ transform: `translateX(-${currentPerformance * 26.5}%)` }}>
