  ...
  return (
    <div className="banner-slider-container">
      ...
      <div className='flex justify-between items-center'>
        <div className=''>
        <img src="https://pngimg.com/d/sword_PNG5525.png" alt="sword" width={350} className='relative -top-10'></img>
        <img src="https://pngimg.com/d/sword_PNG5525.png" alt="sword" width={350} className='relative -top-28'></img>
        </div>
        <h3 className='text-8xl font-semibold text-primary relative -top-14'>शिवकालीन युद्धकला</h3>
        <div className=''>
        <img src="https://pngimg.com/d/sword_PNG5525.png" alt="sword" width={350} className='scale-x-[-1] relative -top-10' ></img>
        <img src="https://pngimg.com/d/sword_PNG5525.png" alt="sword" width={350} className='scale-x-[-1] relative -top-28' ></img>
        </div>
      </div>
    </div>
  );
