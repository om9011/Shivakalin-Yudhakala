  ...
  return (
    <div className="banner-slider-container">
      ...
      <div className='flex justify-between items-center'>
        ...
        <div className=''>
        <img src="https://pngimg.com/d/sword_PNG5525.png" alt="sword" width={350} className='scale-x-[-1] relative -top-8' ></img>
        <img src="https://pngimg.com/d/sword_PNG5525.png" alt="sword" width={350} className='scale-x-[-1] relative -top-24' ></img>
        </div>
      </div>
    </div>
  );
