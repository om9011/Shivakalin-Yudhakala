...
const Slider = () => {
  ...
  return (
    <div className="banner-slider-container">
      ...
      <div className=''>
        <img src="https://pngimg.com/d/sword_PNG5525.png" alt="sword" width={350} className='relative top-0'></img>
        <img src="https://pngimg.com/d/sword_PNG5525.png" alt="sword" width={350} className='relative topo-0'></img>
      </div>
    </div>
  );
};
