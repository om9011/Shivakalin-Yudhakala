...
const Slider = () => {
  ...
  return (
    <section id='home' className="banner-slider-container">
      ...
      <img src="https://pngimg.com/d/sword_PNG5525.png" alt="sword" width={350} className='relative -top-4 md:w-150'></img>
        <h3 className='text-xl md:text-2xl lg:text-8xl font-semibold text-primary '>शिवकालीन युद्धकला</h3>
