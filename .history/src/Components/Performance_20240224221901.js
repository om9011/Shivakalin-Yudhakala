...
const PerformanceSection = () => {
    ...
    return (
        <section id='performance-slider-container' className="performance-slider-container bg-background flex flex-col items-center justify-start py-14">
            ...
            <div className="navigation-buttons">
                    ...
                    <button onClick={handleNextPerformance}><i class='bx bxs-right-arrow'></i></button></div>
        </section>
    );
};
