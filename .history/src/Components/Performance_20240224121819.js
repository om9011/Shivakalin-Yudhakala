    ...
    <div className="performance-slider-container py-10 bg-background">
      ...
      <div className="performance-slider" style={{ transform: `translateX(-${currentPerformance * 100}%)` }}>
        {performances.map((performance, index) => (
          <div key={performance.id} className="performance-card border flex flex-col items-center jus">
            <img src={performance.image} alt={`Performance ${performance.id}`} className="w-96 aspect-video " />
