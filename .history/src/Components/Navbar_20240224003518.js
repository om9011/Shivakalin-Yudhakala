    ...
    <nav>
      <div className="flex fixed items-center justify-between border border-gray-400 py-4 px-8 w-full z-10 bg-white">
        <div className="flex gap-4 items-center">
          ...
          <span className="text-3xl text-primary font-semibold pt-2">शिवकालीन युद्धकला</span>
        </div>
        <ul className="flex gap-3 text-xl">
          ...
          <li><a className='rounded-sm duration-400 border-0 px-4 hover:border-b-4 hover:border-b-primary' href="#archery">सादरीकरणे </a></li>
