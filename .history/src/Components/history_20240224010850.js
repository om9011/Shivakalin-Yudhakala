            ...
            <div className="container mx-auto px-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    <div className="bg-white rounded-lg">
                        ...
                        />
                        <h3 className="text-2xl font-semibold my-4 text-tertiary">दंड</h3>
                        <p className="text-gray-700 text-justify px-6 py-4">
                    ...
                    <div className="bg-white rounded-lg">
                        ...
                        />
                        <h3 className="text-2xl font-semibold my-4 text-tertiary">तलवार</h3>
                        <p className="text-gray-700 text-justify px-6">
                            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus
                            posuere nibh lacus, sed aliquet libero convallis cursus. Donec
                            convallis sem dapibus faucibus ultricies. Mauris a fringilla odio.
                            In sodales, turpis vitae imperdiet facilisis, dolor quam laoreet
                    ...
                    <div className="bg-white rounded-lg ">
                        <img
                            ...
                            alt="दानपट्टा"
                        />
                        <h3 className="text-2xl font-semibold my-4 text-tertiary">
                            दानपट्टा
                        </h3>
                        <p className="text-gray-700 text-justify px-6">
                            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus
