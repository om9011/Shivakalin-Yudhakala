  ...
  return (
    <section id='contact' className="max-w-lg mx-auto mt-10">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        <div>
          <label htmlFor="name" className="text-5xl block mb-1">नाव</label>
          <input
            type="text"
            id="name"
            name="name"
        ...
        <div>
          <label htmlFor="email" className="text-5xl block mb-1">ईमेल</label>
          <input
            type="email"
            id="email"
            name="email"
        ...
        <div>
          <label htmlFor="message" className="text-5xl block mb-1">संदेश</label>
          <textarea
            id="message"
            name="message"
