...
const Navbar = ({children}) => {
  return (
    <header>
    <nav>
      <div className="flex fixed items-center justify-between border border-b-gray-400 py-4 z-10 px-8 w-full bg-white">
        ...
        <ul className="flex gap-3 text-xl">
          <li><a className='rounded-sm duration-400 border-0 px-4 hover:border-b-4 hover:border-b-primary' href="#history">इतिहास</a></li>
          <li><a className='rounded-sm duration-400 border-0 px-4 hover:border-b-4 hover:border-b-primary' href="#wardhinee">'स्व'-रूपवर्धिनी</a></li>
